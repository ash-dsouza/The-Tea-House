...
<html>
  ...
  <head>
    <title> Manager Login | The Tea House</title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">The Tea House</a>
        </div>
...
<div class="container">
    <div class="jumbotron">
     <h1>Hello Manager! </h1>
     <p>Manage all your website from here</p>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item ">My Cafe</a>
    		<a href="view_food_items.php" class="list-group-item ">View Tea Items</a>
    		<a href="add_food_items.php" class="list-group-item ">Add Tea Items</a>
    		<a href="edit_food_items.php" class="list-group-item active">Edit Tea Items</a>
    		<a href="delete_food_items.php" class="list-group-item ">Delete Tea Items</a>
        <a href="view_order_details.php" class="list-group-item ">View Tea Details</a>
    	</div>
    </div>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT YOUR TEA ITEMS HERE </h3>
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Tea Name: </label>
            <input type="text" class="form-control" id="dname" name="dname" value=<?php echo $row1['name'];  ?> placeholder="Your Food name" required="">
          </div>     

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Tea Price: </label>
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Tea Description: </label>
